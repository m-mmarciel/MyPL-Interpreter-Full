...
class Visitor(object):
    ...
    """
    def visit_stmt_list(self, stmt_list): pass #DONE
    def visit_expr_stmt(self, expr_stmt): pass #DONE
    def visit_var_decl_stmt(self, var_decl): pass #DONE
    def visit_assign_stmt(self, assign_stmt): pass #DONE
    def visit_struct_decl_stmt(self, struct_decl): pass #///////////////// DONE
    def visit_fun_decl_stmt(self, fun_decl): pass ##///////////////// DONE
    def visit_return_stmt(self, return_stmt): pass #DONE
    def visit_while_stmt(self, while_stmt): pass #DONE
    def visit_if_stmt(self, if_stmt): pass #DONE
    def visit_simple_expr(self, simple_expr): pass #DONE
    def visit_complex_expr(self, complex_expr): pass #DONE
    def visit_bool_expr(self, bool_expr): pass #DONE
    def visit_lvalue(self, lval): pass #/////////////////
    def visit_fun_param(self, fun_param): pass #///////////////// DONE
    def visit_simple_rvalue(self, simple_rvalue): pass #DONE
    def visit_new_rvalue(self, new_rvalue): pass #///////////////// DONE
    def visit_call_rvalue(self, call_rvalue): pass #///////////////// DONE
